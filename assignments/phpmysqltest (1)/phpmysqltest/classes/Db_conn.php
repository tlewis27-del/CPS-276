...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'tlewis27';//this will be your WCC username
      $dbUsr = 'tlewis27';//this will be your WCC username
      $dbPass = '0pFvB99oA5uCNmT';//this will be the password found in the video.
